...
describe('Vault — Screen Captures', () => {
  ...
  test('createCapture + getCapture', () => {
    const row = createCapture({
      ...
      pixelChangePct: 0.15,
      appName: 'VS Code',
      windowTitle: 'index.ts - mogoi - Visual Studio Code',
  ...
  test('createCapture persists sidecarId for fetch_capture routing', () => {
    const row = createCapture({
      ...
      imagePath: '/home/user/.mogoi/captures/2026-05-11/12-00-00.png',
      appName: 'Terminal',
    });
    ...
    expect(fetched!.image_path).toBe('/home/user/.mogoi/captures/2026-05-11/12-00-00.png');
  });

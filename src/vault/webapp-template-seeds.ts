 ...
 *   2. User overrides: ~/.mogoi/webapp-templates/ (user-created or customized)
 *
 ...
 *   2. User overrides from ~/.mogoi/webapp-templates/
...
export function seedWebappTemplates(): void {
  ...
  const userDir = join(homedir(), '.mogoi', 'webapp-templates');

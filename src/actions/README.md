...
Expected output:
```
Testing M.O.G.O.I. Action Layer
...
2. Terminal Executor
   ...
   ✓ Command executed: Hello from MOGOI
   Duration: 35ms
...
5. Tool Registry
   Registered tools: 1
   Categories: utility
   ✓ Tool execution: Echo: Hello MOGOI!
...
Part of Project M.O.G.O.I. - See root LICENSE file.

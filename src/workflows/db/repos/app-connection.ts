 ...
 * Mogoi' keychain will be layered in step 15 by wrapping serialize/deserialize
 * here. The credential adapter (also step 15) will compose this repo with
 * Mogoi' existing OAuth stores so that pieces like Gmail/Telegram see the
 * tokens Mogoi already manages, without users connecting twice.
 */

/**
 * Workflow tables share the single Mogoi SQLite database (`~/.mogoi/mogoi.db`)
...
/**
 * Returns the shared Mogoi DB (same instance as vault's `getDb`). Workflow
...
/**
 * Closes the shared Mogoi DB. Equivalent to vault's `closeDb`. Tests call

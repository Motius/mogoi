...
describe("SandboxApi routes (B2: connections, store, flows)", () => {
  ...
  beforeAll(async () => {
    ...
    // Stub Mogoi source so mogoi:test resolves to a fake OAuth2 connection.
    resolver.register({
      id: "test",
      canResolve: (e) => e === "mogoi:test",
      resolve: async () => ({
        type: "OAUTH2",
  ...
  test("GET /v1/worker/app-connections/:externalId resolves a Mogoi source", async () => {
    const r = await authedFetch("/v1/worker/app-connections/mogoi%3Atest");
    expect(r.status).toBe(200);
    const body = (await r.json()) as { externalId: string; status: string; value: { type?: string; access_token?: string } };
    expect(body.externalId).toBe("mogoi:test");
...
describe("SandboxApi routes (B3: files, waitpoints, logs)", () => {
  ...
  beforeAll(async () => {
    process.env.MOGOI_WORKFLOW_DATA_DIR = `/tmp/mogoi-sandbox-test-${Math.random().toString(36).slice(2, 10)}`;
    initWorkflowDb(":memory:");
    signer = new EngineTokenSigner();
    registry = new SandboxRegistry();
    api = new SandboxApi({
  ...
  afterAll(async () => {
    await api.stop();
    closeWorkflowDb();
    delete process.env.MOGOI_WORKFLOW_DATA_DIR;
  });
...
describe("SandboxApi routes (G: mogoi-tool/notify/context)", () => {
  let api: SandboxApi;
  let signer: EngineTokenSigner;
  let registry: SandboxRegistry;
  ...
  test("POST /v1/mogoi/tools/invoke calls injected fn and returns its reply", async () => {
    const r = await authedFetch("/v1/mogoi/tools/invoke", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/mogoi/tools/invoke 400 on missing toolName", async () => {
    const r = await authedFetch("/v1/mogoi/tools/invoke", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/mogoi/tools/invoke 400 on non-object params", async () => {
    const r = await authedFetch("/v1/mogoi/tools/invoke", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/mogoi/notify dispatches and surfaces delivery report", async () => {
    const r = await authedFetch("/v1/mogoi/notify", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
        message: "hi",
  ...
  test("POST /v1/mogoi/notify defaults channels to ['auto'] and priority to 'normal'", async () => {
    const r = await authedFetch("/v1/mogoi/notify", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/mogoi/notify 400 on unknown channel", async () => {
    const r = await authedFetch("/v1/mogoi/notify", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/mogoi/context/vault-search forwards filter to provider", async () => {
    const r = await authedFetch("/v1/mogoi/context/vault-search", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/mogoi/context/vault-search 400 on invalid type", async () => {
    const r = await authedFetch("/v1/mogoi/context/vault-search", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/mogoi/context/vault-get-entity forwards id", async () => {
    const r = await authedFetch("/v1/mogoi/context/vault-get-entity", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/mogoi/context/awareness-recent forwards limit/since", async () => {
    const r = await authedFetch("/v1/mogoi/context/awareness-recent", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/mogoi/context/commitments-list forwards status filter", async () => {
    const r = await authedFetch("/v1/mogoi/context/commitments-list", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/mogoi/context/commitments-list 400 on invalid status", async () => {
    const r = await authedFetch("/v1/mogoi/context/commitments-list", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
describe("SandboxApi routes (G unconfigured -> 503)", () => {
  ...
  test("context routes without provider return 503", async () => {
    for (const path of [
      "/v1/mogoi/context/vault-search",
      "/v1/mogoi/context/vault-get-entity",
      "/v1/mogoi/context/awareness-recent",
      "/v1/mogoi/context/commitments-list",
    ]) {
...
describe("SandboxApi routes (H: mogoi-agent/trigger)", () => {
  let api: SandboxApi;
  let signer: EngineTokenSigner;
  let registry: SandboxRegistry;
  ...
  test("POST /v1/mogoi/agent/delegate forwards goal/role/maxIterations", async () => {
    const r = await authedFetch("/v1/mogoi/agent/delegate", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/mogoi/agent/delegate 400 on missing goal", async () => {
    const r = await authedFetch("/v1/mogoi/agent/delegate", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/mogoi/agent/delegate 400 on non-integer maxIterations", async () => {
    const r = await authedFetch("/v1/mogoi/agent/delegate", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/mogoi/events/poll forwards eventType+filter+since", async () => {
    pollReply = {
      events: [
    ...
    const r = await authedFetch("/v1/mogoi/events/poll", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
  ...
  test("POST /v1/mogoi/events/poll 400 on missing eventType", async () => {
    const r = await authedFetch("/v1/mogoi/events/poll", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/mogoi/events/poll 400 on negative since", async () => {
    const r = await authedFetch("/v1/mogoi/events/poll", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/mogoi/workflows/start dispatches with flowId and payload", async () => {
    const r = await authedFetch("/v1/mogoi/workflows/start", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/mogoi/workflows/start 400 when flowId is missing", async () => {
  ...
  test("POST /v1/mogoi/workflows/start 400 when flowId is empty", async () => {
    const r = await authedFetch("/v1/mogoi/workflows/start", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
describe("SandboxApi routes (workflows/start error mapping)", () => {
  ...
  async function start(): Promise<Response> {
    return authedFetch("/v1/mogoi/workflows/start", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
describe("SandboxApi /v1/mogoi/* envelope hardening (G+H review #7)", () => {
  let api: SandboxApi;
  let signer: EngineTokenSigner;
  let registry: SandboxRegistry;
  ...
  const JSON_POST_PATHS = [
    "/v1/mogoi/llm/chat",
    "/v1/mogoi/tools/invoke",
    "/v1/mogoi/notify",
    "/v1/mogoi/context/vault-search",
    "/v1/mogoi/context/vault-get-entity",
    "/v1/mogoi/context/awareness-recent",
    "/v1/mogoi/context/commitments-list",
    "/v1/mogoi/agent/delegate",
    "/v1/mogoi/events/poll",
    "/v1/mogoi/workflows/start",
  ] as const;

  test("each /v1/mogoi/* POST returns 400 on malformed JSON", async () => {
  ...
  test("each /v1/mogoi/* POST returns 400 on a non-object body", async () => {
    for (const path of JSON_POST_PATHS) {
      const r = await authedFetch(path, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  test("/v1/mogoi/events/poll headOnly mode skips 'since' and returns the head cursor", async () => {
    const r = await authedFetch("/v1/mogoi/events/poll", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("/v1/mogoi/events/poll without 'since' and without headOnly returns 400", async () => {
    const r = await authedFetch("/v1/mogoi/events/poll", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("each /v1/mogoi/* POST handles a 256KB+ payload without crashing", async () => {
    // The store route caps at 500KB; the mogoi routes have no explicit cap

/**
 * Phase L plumbing smoke (gated on MOGOI_TEST_ENGINE_BUILD=1).
 *
 ...
 * dragging in `googleapis` and friends. Uses the `mogoi-validate` test
 ...
 *   - The engine resolves `{{connections['mogoi:validate']}}` against the

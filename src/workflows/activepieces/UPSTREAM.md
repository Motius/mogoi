...
This directory contains a vendored subtree of the [Activepieces](https://github.com/activepieces/activepieces) project, used as the foundation of the Mogoi Workflow system.
...
- `packages/server/api` -- NestJS HTTP server. Replaced by integration into the Mogoi daemon's HTTP surface (Phase 2).
...
Plus the Mogoi-native pieces (Phase 3): `mogoi-ask`, `mogoi-agent`, `mogoi-tool`, `mogoi-context`, `mogoi-notify`, `mogoi-trigger`.

/**
 * Tests for `MogoiWorkflowRunnerAdapter`.
 *
...
import { MogoiWorkflowRunnerAdapter, WorkflowRunnerError } from "./workflow-runner";
...
describe("MogoiWorkflowRunnerAdapter", () => {
  let adapter: MogoiWorkflowRunnerAdapter;

  beforeEach(() => {
    initWorkflowDb(":memory:");
    adapter = new MogoiWorkflowRunnerAdapter();
  });

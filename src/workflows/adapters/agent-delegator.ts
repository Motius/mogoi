 ...
 *      is the baseline that works without M7 wired up: it gets `mogoi-agent`
...
export class LlmOnlyAgentDelegator implements PieceAgentDelegator {
  constructor(
    ...
    private readonly systemPrompt: string = "You are a Mogoi sub-agent. Plan briefly, then answer the user's goal directly. If you would need a tool you don't have, say so explicitly.",
  ) {}

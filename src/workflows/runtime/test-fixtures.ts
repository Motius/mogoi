 ...
 * Mogoi-native pieces' shape. Used by composer / manage-workflow / API
...
export function sampleCatalog(): PieceCatalog {
  const entries: PieceCatalogEntry[] = [
    ...
    },
    {
      ...
      actions: {
        notify: {
          ...
          description: "Deliver a message through Mogoi's configured channels.",
          inputSchema: {
            fields: [
    ...
    },
    {
      ...
      description: "Bridge Mogoi events into workflows.",
      actions: {
        run_workflow: {
          name: "run_workflow",
      ...
      triggers: {
        on_event: {
          ...
          description: "Fire the workflow when a Mogoi event of the given type is published.",
          inputSchema: {
            fields: [

/**
 * In-memory recent-events buffer that backs the `/v1/mogoi/events/poll`
 * route used by the `mogoi-trigger:on_event` polling trigger.
 *
 * The daemon's existing `MogoiEventBusAdapter` is publish/subscribe; this

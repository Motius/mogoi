...
export interface CatalogEntry {
  /**
   * Stable Mogoi-side id. URL slug, manifest key. NEVER rename once shipped --
  ...
  iconUrl?: string;
  /**
   * Exact version Mogoi last tested end-to-end. For verified pieces this
...
/** Look up a catalog entry by Mogoi-side id. Returns null when missing. */

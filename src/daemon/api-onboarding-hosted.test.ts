...
import { effectiveLlmForBinding, effectiveTtsForBinding } from './motius-ai.ts';
...
const hostedConfig = (): MogoiConfig => {
...
describe('POST /api/onboarding/setup on a hosted install', () => {
  ...
  beforeEach(() => {
    ...
    secretsDir = mkdtempSync(join(tmpdir(), 'mogoi-onboarding-hosted-'));

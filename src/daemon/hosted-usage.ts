...
export function readHostedUsageConfig(config: MogoiConfig): HostedUsageConfig | null {
...
export function makeHostedUsageReader(
...
): (config: MogoiConfig) => Promise<HostedUsageMeter | null> {
  ...
  return async (config: MogoiConfig) => {
...
export function readHostedUsage(config: MogoiConfig): Promise<HostedUsageMeter | null> {

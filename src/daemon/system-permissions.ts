 ...
 * the same TCC state the native `mogoi --setup` wizard reads (one source of
...
export type PermissionsResult =
  | {
       ...
       * binary instead of Mogoi.app). The rows then describe whatever launched
 ...
 * user a list Mogoi is not in. macOS prompts for both in the moment, which is
 ...
 * localhost:1846 in a real browser has no panel cookie, and neither does ANY

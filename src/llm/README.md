...
Mogoi also includes first-class adapters for Groq, Gemini, OpenRouter, NVIDIA NIM, LiteLLM, and generic OpenAI-compatible endpoints.
...
Make sure you have a valid config at `~/.mogoi/config.yaml` with API keys set.

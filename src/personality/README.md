...
An adaptive personality system for M.O.G.O.I. that learns user preferences and adapts communication style over time.
...
See [docs/PERSONALITY_ENGINE.md](~/mogoi/docs/PERSONALITY_ENGINE.md) for full documentation.

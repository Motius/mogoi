...
**Endpoints:**
- `ws://localhost:1846/ws` - WebSocket connection
- `http://localhost:1846/health` - Health check
- `http://localhost:1846/` - Server info
...
// Send message
await telegram.sendMessage('CHAT_ID', 'Hello from M.O.G.O.I.!');
```
...
## Integration with M.O.G.O.I. Daemon
...
- Check port 1846 is not in use: `lsof -i :1846`

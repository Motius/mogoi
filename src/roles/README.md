...
The Role Engine is a core component of Project M.O.G.O.I. that defines, loads, and manages AI agent roles with their permissions, responsibilities, and behavior patterns.

...
export function classifyGoogle(config: { google?: MogoiConfig['google'] }): GoogleShape {
...
export function makeGoogleAuth(
  config: { google?: MogoiConfig['google'] },
  fetchImpl: typeof fetch = fetch,
 ...
 */
export function googleIdentity(config: { google?: MogoiConfig['google'] }): string | null {
  const shape = classifyGoogle(config);

...
const TEST_CONFIG_PATH = '/tmp/mogoi-cli-lifecycle-config.yaml';
const MISSING_CONFIG_PATH = '/tmp/mogoi-cli-lifecycle-missing.yaml';
...
describe('resolveStopPort precedence', () => {
  ...
  test('explicitly-set port 1846 in config reports source "config", not "default"', async () => {

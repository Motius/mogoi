 ...
 * ambitions / communication / rhythm / tools / what-mogoi-does).
 *
 ...
 * "About the user" markdown block injected into Mogoi's system prompt.
 */
...
export const USER_PROFILE_QUESTIONS: UserProfileQuestion[] = [
  {
    ...
    prompt: 'What should MOGOI call you?',
  ...
  },
  {
    ...
    step_title: 'Identity',
    label: 'Pronouns',
    prompt: 'What pronouns do you want MOGOI to use, if any?',
  ...
  },
  {
    ...
    prompt: 'What location or timezone should MOGOI keep in mind?',
  ...
  },
  {
    ...
    description: 'Short-term outcomes that MOGOI should optimize around.',
    placeholder: 'What should MOGOI help push forward?',
    multiline: true,
  },
  {
    ...
    prompt: 'How do you want MOGOI to communicate with you?',
  ...
  },
  {
    ...
    placeholder: 'What should MOGOI not do?',
    multiline: true,
  },
  {
    ...
    prompt: 'What routines, limits, or constraints should MOGOI know?',
  ...
  },
  {
    ...
    description: 'Software, devices, languages, frameworks, and workflows MOGOI should assume.',
  ...
  },
  {
    ...
    placeholder: 'Who should MOGOI keep in mind?',
    multiline: true,
  },
  {
    id: 'anything_else',
    ...
    step_title: 'Context',
    label: 'Anything Else',
    prompt: 'What else should MOGOI know to be useful from day one?',
 ...
 * intent classifier — both paths get the same context so Mogoi is

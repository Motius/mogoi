    ...
    <div className="rk-tasks__overlay" onClick={() => !busy && onClose()}>
      <div className="rk-tasks__dialog" role="dialog" aria-modal="true" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="rk-tasks__dialog-body">
          ...
          <div><div className="rk-tasks__flab">assignee · optional</div><input className="rk-tasks__input" value={assigned} onChange={(e) => setAssigned(e.target.value)} placeholder="you / mogoi / agent name" /></div>

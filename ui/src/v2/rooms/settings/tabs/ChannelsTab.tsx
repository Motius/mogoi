...
// OpenAI-style voices the hosted MotiusAI TTS accepts (see createTTSProvider:
      ...
      <section className="v2-set__section">
        ...
        <div className="v2-set__field">
          ...
          <div style={{ display: "flex", gap: "var(--s-2)", alignItems: "center" }}>
            ...
            >
              {sttCfg?.motius_available && (
                <option value="motius">MotiusAI AI (included)</option>
              )}
            ...
            {sttCfg?.motius_available && sttCfg?.provider !== "motius" && (
              <button
                type="button"
      ...
      <section className="v2-set__section">
        ...
        <div className="v2-set__field">
          ...
          <div style={{ display: "flex", gap: "var(--s-2)", alignItems: "center" }}>
            ...
            {ttsCfg?.motius_available && ttsCfg?.provider !== "motius" && (
              <button
                type="button"
                className="v2-set__btn v2-set__btn--icon"
                title="Reset to your plan's included voice"
            ...
            <button
              ...
              onClick={async () => {
                ...
                const res = await fetch("/api/tts/preview", {
                  ...
                  body: JSON.stringify({ provider: "motius", voice }),
                });
                if (!res.ok) {

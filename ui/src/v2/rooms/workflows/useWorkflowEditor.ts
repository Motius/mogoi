...
export interface PieceCatalogActionOrTrigger {
   ...
   * whose envelope shape depends on a config value (mogoi-trigger
 ...
 * connection-less pieces (mogoi-ask, schedule, code, webhook). The
...
export function useWorkflowEditor(flowId: string | null) {
   ...
   *   event    -> @mogoipieces/piece-mogoi-trigger:on_event
   *

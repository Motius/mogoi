...
export function AppShellV2() {
  ...
  if (route.kind === "panel") {
    ...
    return (
      <div className="mogoi-v2-root mogoi-v2-panel-mode">
        <ConfirmHost />
  ...
  if (route.kind === "task") {
    return (
      <div className="mogoi-v2-root mogoi-v2-task-mode">
  ...
  if (route.kind === "palette") {
    return (
      <div className="mogoi-v2-root mogoi-v2-palette-mode">
        <PalettePage />
      </div>
    );
  }
      ...
      {route.kind === "primitives" ? (
        ...
        <>
          {/* Cold-start splash — overlays the booting app until the gate
              resolves (dispatches mogoi:boot-ready), then cross-fades away. */}
          <BootSplash />

...
<div class="pagebody" tabindex="-1">
  ...
  <div class="center">
    <div class="formbox">
      ...
      <h1>Connect this machine to Mogoi</h1>
      <p class="sub">On the machine running your brain, run
        <b>mogoi enroll "&lt;device-name&gt;"</b> in a terminal and paste the
      ...
      <p class="hint">The token is stored locally at ~/.mogoi/sidecar.yaml. Press Cmd/Ctrl+Enter to connect.</p>
      <div class="row">
        <span id="err"></span>

...
func TestNewSidecarClientUsesConfigBrainOverride(t *testing.T) {
	...
	cfg.Token = fakeToken(t, SidecarTokenClaims{
		...
		Sid:   "sid",
		Name:  "test",
		Brain: "ws://127.0.0.1:1846/sidecar/connect",
		JWKS:  "http://127.0.0.1:1846/api/sidecars/.well-known/jwks.json",
		Iat:   1,
	})
	cfg.Brain = "10.0.0.25:1846"
	...
	if client.claims.Brain != "ws://10.0.0.25:1846/sidecar/connect" {

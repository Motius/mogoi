...
// file (~/.mogoi/sidecar.log) with search, copy, and export. Entirely local:
...
func runLogViewer(logPath string) {
	runLocalWebview("MOGOI — Logs", 900, 600, webview.HintNone, winchrome.CustomTitleBar, func(w webview.WebView) func() {

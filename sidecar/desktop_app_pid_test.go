...
const psAppsFixture = `    1 /sbin/launchd
  ...
  977 /Applications/Mogoi.app/Contents/MacOS/mogoi
 ...
 2001 /Users/me/src/mogoi/sidecar/dist/macos/Mogoi.app/Contents/MacOS/mogoi
...
func TestAppProcessPidFindsTheAppsMainProcess(t *testing.T) {
	cases := []struct {
		...
		{"Mogoi", 2001, "case differs from the mogoi executable; two instances, newest wins"},
		{"mogoi", 2001, "open -a is case-insensitive, so the lookup must be too"},

...
const (
	...
	// the MOGOI_RELAUNCH marker) before initializing services. Must exceed
...
// MOGOI_RELAUNCH marker makes the new process wait restartRelaunchWait on
...
func relaunchSidecar() (*exec.Cmd, error) {
	...
	cmd.Env = append(os.Environ(), "MOGOI_RELAUNCH=1")

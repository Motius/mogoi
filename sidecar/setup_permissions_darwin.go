...
// the installer never requests them — only the installed, signed Mogoi.app
// may (see code-signing/macos-setup.md in the motius-docs repo).
//
...
// The request makes Mogoi appear in the Settings pane list; macOS never
...
// and Accessibility have none - the request only registers Mogoi in the
...
// to. False when the sidecar runs as a bare binary instead of Mogoi.app.

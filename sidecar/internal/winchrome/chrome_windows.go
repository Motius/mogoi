...
func bindControls(w webview.WebView, hwnd uintptr) bool {
	...
	bind("__mogoi_chrome_drag", func() {
		procReleaseCapture.Call()
		procSendMessageW.Call(hwnd, wmNCLButtonDown, htCaption, 0)
	})

	bind("__mogoi_chrome_minimize", func() {
	...
	bind("__mogoi_chrome_toggle_maximize", func() bool {
		if isZoomed(hwnd) {
	...
	bind("__mogoi_chrome_is_maximized", func() bool { return isZoomed(hwnd) })
	...
	bind("__mogoi_chrome_close", func() {
	...
	bind("__mogoi_chrome_sync", func(custom bool) { syncCaption(hwnd, custom) })
	...
	bind("__mogoi_chrome_sysmenu", func() {
		var pt point

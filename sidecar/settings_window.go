...
func (c *SidecarClient) runSettingsWindow() {
	runLocalWebview("MOGOI — Sidecar Settings", 520, 560, webview.HintNone, winchrome.CustomTitleBar, func(w webview.WebView) func() {
		...
		_ = w.Bind("saveToken", func(raw string) error {
			...
			if _, err := DecodeJWTPayload(raw); err != nil {
				return fmt.Errorf("That doesn't look like a valid token. Copy the full token printed by 'mogoi enroll'.")
			}
...
<head>
<meta charset="utf-8">
<title>MOGOI — Sidecar Settings</title>
...
<div class="pagebody" tabindex="-1">
  ...
  <div class="panel">
    <div class="srow">
      <div class="sl7"><div class="a">Brain connection</div><div class="b">Live status of this machine's link to Mogoi.</div></div>
  ...
  <div class="panel">
    ...
    <div class="srow">
      <div class="sl7"><div class="a">Open dashboard at startup</div><div class="b">Show the full Mogoi window every time the sidecar starts, not just the pebble.</div></div>
  ...
  <div class="panel">
    <div class="srow">
      <div class="sl7"><div class="a">Ethereal pebble</div><div class="b">Fade the pebble out while it sits idle; it pops back in when Mogoi activates.</div></div>
...
<script>
  ...
  async function doRestart() {
    ...
    try {
      ...
      msg.textContent = 'Restarting Mogoi…';
    } catch (e) {
      btn.disabled = false;

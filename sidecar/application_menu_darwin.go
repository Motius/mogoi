...
static void mogoiAddEditCommand(NSMenu* menu, NSString* title, SEL action,
...
static BOOL mogoiHasEditMenu(NSMenu* mainMenu) {
...
static void mogoiInstallApplicationMenusOnMain(void) {
    ...
    mogoiAddEditCommand(editMenu, @"Undo", @selector(undo:), @"z",
                         NSEventModifierFlagCommand);
    mogoiAddEditCommand(editMenu, @"Redo", @selector(redo:), @"z",
                         NSEventModifierFlagCommand | NSEventModifierFlagShift);
    [editMenu addItem:[NSMenuItem separatorItem]];
    mogoiAddEditCommand(editMenu, @"Cut", @selector(cut:), @"x",
                         NSEventModifierFlagCommand);
    mogoiAddEditCommand(editMenu, @"Copy", @selector(copy:), @"c",
                         NSEventModifierFlagCommand);
    mogoiAddEditCommand(editMenu, @"Paste", @selector(paste:), @"v",
                         NSEventModifierFlagCommand);
    mogoiAddEditCommand(editMenu, @"Select All", @selector(selectAll:), @"a",
                         NSEventModifierFlagCommand);
...
static void mogoiInstallApplicationMenus(void) {
    ...
    mogoiInstallApplicationMenusOnMain();
}
*/
import "C"

func installApplicationMenus() {
	C.mogoiInstallApplicationMenus()
}

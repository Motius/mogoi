...
// 1. Vendored mogoi pieces must be compiled before metadata extraction (they
...
// MOGOI_ENGINE_CACHE_ROOT in the builder's env would turn this into a copy

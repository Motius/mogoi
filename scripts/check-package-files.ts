...
export const REQUIRED: Requirement[] = [
  {
    path: "bin/mogoi.ts",
    why: "the hosting fleet's install-version refuses a tarball without it, and the mogoi@ unit's ExecStart runs it",
  },
  {
 ...
 *
 * Lines look like `packed 21.45KB bin/mogoi.ts`; the summary footer

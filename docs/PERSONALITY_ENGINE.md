...
The Personality Engine enables M.O.G.O.I. to learn and adapt its communication style based on user interactions. It maintains a dynamic personality model that evolves over time, adapts to different communication channels, and can be used to generate personalized LLM prompts.
...
const systemMessage = {
  role: 'system',
  content: `
You are M.O.G.O.I., an AI assistant.
